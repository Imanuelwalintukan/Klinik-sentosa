...
const systemLogService = __importStar(require("../services/system-log.service"));
const getAllActivityLogs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const activityLogs = yield systemLogService.getAllActivityLogs(req.query);
        (0, response_1.sendResponse)(res, 200, true, activityLogs);
    }
