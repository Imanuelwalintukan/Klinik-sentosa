...
const createMedicalRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const validation = medical_record_validation_1.createMedicalRecordSchema.safeParse(req.body);
...
const getMedicalRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const record = yield medicalRecordService.getMedicalRecordByAppointmentId(appointmentId);
        if (!record)
            return (0, response_1.sendResponse)(res, 404, false, null, 'Medical record not found');
